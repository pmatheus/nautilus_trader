...
//!
//! The official Bitget API reference can be found at <https://www.bitget.com/api-doc/common/intro>.
...
//! # Documentation
//!
//! See <https://docs.rs/nautilus-bitget> for the latest API documentation.
